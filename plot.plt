set term pngcairo dashed truecolor enhanced size 3000,1500 font "arial,9"
...
plot 'stats.csv' u 1:3 title 'time' w lp axes x1y2 lt 0 ps 2 pt 7 lc rgb 'blue', \
  '' u 1:2 title 'distance' w lp lt 0 ps 2 pt 6 lc rgb '#009900'
...
plot maxsum = 0, meansum = 0, \
  'stats.csv' u 1:5 title 'V_{max}' w p ps 2 pt 8 lc rgb 'red', \
  '' u 1:4 title '  V_{mean}' w p ps 2 pt 10 lc rgb 'orange', \
  ...
  maxsum = 0, meansum = 0, \
  '' u 1:(maxsum = maxsum+$5, maxsum/($0+1)) notitle w l lt 1 lc rgb 'red', \
  '' u 1:(meansum = meansum+$4, meansum/($0+1)) notitle w l lt 1 lc rgb 'orange'

set title 'Total'

plot 'stats.csv' u 1:2 notitle s cumul w filledcu y1=0 lc rgb '#009900', \
  '' u 1:2 title 'distance' s cumul w p ps 2 pt 1 lc rgb '#009900'
